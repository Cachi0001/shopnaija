  ...
  try {
    ...
    if (type === 'confirmation') {
      ...
      htmlContent = `
        ...
        <head>
          ...
          <title>Confirm Your GrowthSmallBeez Account</title>
          <style>
        ...
        <body>
          <div class="container">
            <div class="header">
              <div class="logo">GrowthSmallBeez</div>
              <h1>Welcome to GrowthSmallBeez!</h1>
            </div>
            <div class="content">
              <h2>Confirm Your Account</h2>
              <p>Hello ${data.name || 'there'},</p>
              <p>Thank you for joining GrowthSmallBeez, Nigeria's premier e-commerce platform for small businesses!</p>
            ...
            <div class="footer">
              <p>Best regards,<br><strong>The GrowthSmallBeez Team</strong></p>
              <p>Empowering Nigerian entrepreneurs to build successful online businesses</p>
              <p><small>© 2025 GrowthSmallBeez. All rights reserved.</small></p>
            </div>
          </div>
        </body>
        </html>
      ...
      htmlContent = `
        ...
        <head>
          <meta charset="utf-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Reset Your GrowthSmallBeez Password</title>
          <style>
            body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f4f4f4; }
            .container { max-width: 600px; margin: 0 auto; background: white; }
            .header { background: linear-gradient(135deg, #00A862 0%, #007A4C 100%); color: white; padding: 30px 20px; text-align: center; }
    ...
    const response = await fetch('https://api.sendgrid.com/v3/mail/send', {
      ...
      body: JSON.stringify({
        ...
        from: { 
          email: 'noreply@growthsmallbeez.com.ng', 
          name: 'GrowthSmallBeez' 
        },
        content: [
          {
            type: 'text/html',
