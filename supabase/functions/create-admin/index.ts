...
serve(async (req)=>{
  ...
  try {
    ...
    const { email, password, name, nin, subdomain, website_name, account_name, account_number, bank_name, bank_code, phone, paystack_subaccount_code, primary_color, referral_code, location } = requestBody;
            ...
            personalizations: [
              {
                ...
                subject: 'GrowthSmallBeez - Your Admin Account Created'
              }
            ],
            from: {
